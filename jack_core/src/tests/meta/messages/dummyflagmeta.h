#ifndef TESTS_DUMMYFLAG_META_H
#define TESTS_DUMMYFLAG_META_H
...
class DummyFlag : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<DummyFlag> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<DummyFlag> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "DummyFlag";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "tests.DummyFlag";
    ...
    static const aos::jack::MessageSchemaField& schemaField(DummyFlag::SchemaField field);
