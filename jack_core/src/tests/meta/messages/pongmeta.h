#ifndef TESTS_PONG_META_H
#define TESTS_PONG_META_H
...
class Pong : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<Pong> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<Pong> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "Pong";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "tests.Pong";
    ...
    static const aos::jack::MessageSchemaField& schemaField(Pong::SchemaField field);
