#ifndef TESTS_PING_META_H
#define TESTS_PING_META_H
...
class Ping : public aos::jack::Message
{
public:
    /**************************************************************************
    ...
    static std::unique_ptr<Ping> createFromPointer(const aos::jack::Message* msg);
    ...
    static std::string toStringArray(aos::jack::Span<Ping> array);
    ...
    static constexpr inline std::string_view CLASS_NAME = "Ping";

    /// The name of this object in the JACK model
    static constexpr inline std::string_view MODEL_NAME = "tests.Ping";
    ...
    static const aos::jack::MessageSchemaField& schemaField(Ping::SchemaField field);
